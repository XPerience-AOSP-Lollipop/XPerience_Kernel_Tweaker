...
public class PFKActivity extends Activity implements ActivityThemeChangeInterface, Constants {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mh1.setText(Helpers.LeerUnaLinea(PFK_HOME_IGNORED_KP));
        ...
        mh1.setText(Helpers.LeerUnaLinea(PFK_HOME_ALLOWED_IRQ));
        ...
        mh2.setText(Helpers.LeerUnaLinea(PFK_HOME_REPORT_WAIT));
        ...
        r1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int currentProgress = Integer.parseInt(Helpers.LeerUnaLinea(PFK_HOME_ALLOWED_IRQ));
        ...
        r2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int currentProgress = Integer.parseInt(Helpers.LeerUnaLinea(PFK_HOME_REPORT_WAIT));
        ...
        mh3.setText(Helpers.LeerUnaLinea(PFK_MENUBACK_IGNORED_KP));
        ...
        mh4.setText(Helpers.LeerUnaLinea(PFK_MENUBACK_INTERRUPT_CHECKS));
        ...
        mh5.setText(Helpers.LeerUnaLinea(PFK_MENUBACK_FIRST_ERR_WAIT));
        ...
        mh6.setText(Helpers.LeerUnaLinea(PFK_MENUBACK_LAST_ERR_WAIT));
        ...
        r3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int currentProgress = Integer.parseInt(Helpers.LeerUnaLinea(PFK_MENUBACK_INTERRUPT_CHECKS));
        ...
        r4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int currentProgress = Integer.parseInt(Helpers.LeerUnaLinea(PFK_MENUBACK_FIRST_ERR_WAIT));
        ...
        r5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int currentProgress = Integer.parseInt(Helpers.LeerUnaLinea(PFK_MENUBACK_LAST_ERR_WAIT));
        ...
        m1.setChecked(mPreferences.getBoolean(PFK_HOME_ON, Helpers.LeerUnaLinea(PFK_HOME_ENABLED).equals("1")));
        ...
        m2.setChecked(mPreferences.getBoolean(PFK_MENUBACK_ON, Helpers.LeerUnaLinea(PFK_MENUBACK_ENABLED).equals("1")));
