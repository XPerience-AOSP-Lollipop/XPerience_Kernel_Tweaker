...
public class GobernorActivity extends Activity implements Constants, AdapterView.OnItemClickListener, ActivityThemeChangeInterface {
        ...
        protected void onPostExecute(String result) {
            if (result.equals("nok")) {
                ...
                if (props.isEmpty()) {
                    ...
                    adapter = new PropAdapter(GobernorActivity.this, R.layout.prop_item, props);
