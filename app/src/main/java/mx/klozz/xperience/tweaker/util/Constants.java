...
public interface Constants {
    ...
    public static final String URL = "http://klozz.github.io/git.klozz.personal/";
    public static final String PAYPAL = "http://forum.xda-developers.com/donatetome.php?u=4403780";
    public static final String licensia ="http://xpe.cynd.gq/lic.html";
    ...
    //Intelli_plug new version :) with Intelli_profiles
    public static final String INTELLI_PROFILES = "/sys/module/intelli_plug/parameters/nr_run_profile_sel";
    public static final String INTELLI_NR_CORES ="/sys/module/intelli_plug/parameters/nr_possible_cores";
    public static final String INTELLI_SCREEN_TOUCH_BOOST ="/sys/module/intelli_plug/parameters/touch_boost_active";
    public static final String INTELLI_SCREEN_OFF_FREQ="/sys/module/intelli_plug/parameters/screen_off_max";
    ...
    public static final String PREF_INTELLI_PROFILES = "pref_intelliprof";
    ...
    // XPerience Kernel Tweaker Settings
    ...
    public static final String INTENT_PP = "com.h0rn3t.performance2profile.change_system";


    public static final String INIT_D = "system/etc/init.d/";

    //Thermal V2
    public static final String THERMAL_CPUS_OFFLINE ="/sys/module/msm_thermal_v2/core_control/cpus_offlined";//Number of CPU off
