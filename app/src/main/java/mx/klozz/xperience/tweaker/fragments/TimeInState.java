/*
 * performance2 Control - An Android CPU Control application Copyright (C)
...
import mx.klozz.xperience.tweaker.util.CPUStateMonitor;
import mx.klozz.xperience.tweaker.util.CPUStateMonitor.CPUStateMonitorException;
import mx.klozz.xperience.tweaker.util.CPUStateMonitor.CpuState;
...
public class TimeInState extends Fragment implements Constants {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.time_in_state, menu);
    }
